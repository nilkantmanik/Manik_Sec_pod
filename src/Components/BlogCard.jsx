    ...
    >
      <div className="flex items-center mb-4">
        <div className="w-14 h-14 rounded-full overflow-hidden relative">
          <img src={avatarUrl} alt="sample45" className="w-full h-full object-cover" />
        </div>
        <div className="ml-4">
        ...
        <div className="ml-auto w-10 h-10 flex items-center justify-center bg-purple-200/5 border border-purple-400/12 rounded-full shadow-inner shadow-purple-400/20">
          <img src="https://framerusercontent.com/images/OwiWD7I1kftgOiRqcw5iS2ksfiE.svg" alt="sam65" className="w-full h-full object-cover" />
        </div>
      </div>
      ...
      <div className="relative border border-purple-200/12 backdrop-blur-lg bg-purple-200/5 rounded-xl overflow-hidden">
        <img src={imageUrl} alt="sam54" className="w-full h-full object-cover" />
