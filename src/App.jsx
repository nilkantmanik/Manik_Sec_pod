...
function App() {
  return (
    <div>
      ...
      <header className="w-full py-4 px-8 flex justify-center items-center ">
        <div className="flex justify-between items-center w-full max-w-screen-lg bg-gray-800 bg-opacity-50 p-4 rounded-xl">
          <div className="text-lg font-semibold">
            <img alt="sample" src='https://framerusercontent.com/images/sh08yhQRcgeLTg8MSig179cTQ8.png'/>
          </div>
      ...
      <div className="flex justify-between items-center w-full max-w-screen-lg bg-gray-800 bg-opacity-50 p-4 rounded my-8">
        <img alt="sample" src="https://framerusercontent.com/images/7cluiGa2zIXh4KaBoIiX4Wd7g.png" />
      </div>
  ...
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img alt="sample" src="https://framerusercontent.com/images/b7Y3O7MuT7iGqIn9B8URsLPe9Zs.svg"  className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img alt="sample" src="https://framerusercontent.com/images/2FqRvjIsBIFF4zz0B5qX5zjd9ho.svg"  className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img alt="sample" src="https://framerusercontent.com/images/H0nYSP9UqjVanFxgROEITBt8c.svg"  className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img alt="sample" src="https://framerusercontent.com/images/ImBGm7FEySu7sDDQIAnnolcQq4.svg"  className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img alt="sample" src="https://framerusercontent.com/images/eboSRZ3S0bc7XvtDG9NJTZkNr8.svg"  className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img alt="sample" src="https://framerusercontent.com/images/hLfweuYR0swEKeJaGTFJTXcJz4M.svg"  className="w-full h-full object-cover rounded-lg"/>
  </div>
</div>
...
<div className="flex justify-between items-center w-full max-w-screen-lg bg-gray-800 bg-opacity-0 p-1 rounded">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white rounded-lg shadow-md p-6 bg-opacity-5 ">
                 ...
                 <img alt="sample" src="https://cdn.create.vista.com/api/media/small/440249754/stock-video-turquoise-pencil-and-gear-icon-isolated-on-blue-background-creative-development-blogging-or-copywriting-concept?videoStaticPreview=true&token="  />
                  </div>
    ...
    <div className='flex justify-between items-center w-full max-w-screen-lg bg-gray-800 bg-opacity-0 p-1 rounded px-10'>
      <div className=' flex justify-between px-1  py-10'>
            <div className='border border-black rounded-lg '>
              <img alt="sample" src="https://framerusercontent.com/images/3uS8DUPZeyJ5GU35aRHJgFx594.png"  />
            </div>
            <div className='border border-black rounded-lg  '>
              <img alt="sample" src="https://framerusercontent.com/images/XZv3jSCQ5RqwC9bnJNfup2aWB90.png"  />
            </div>
            <div className='border border-black rounded-lg '>
              <img alt="sample" src="https://framerusercontent.com/images/i92vyn1xS1aIVks1HCJduxyc1I.png" />
            </div>
          </div>
      </div>
