  ...
  return (
    <div>
      ...
      <header className="w-full py-4 px-8 flex justify-center items-center ">
        <div className="flex justify-between items-center w-full max-w-screen-lg bg-gray-800 bg-opacity-50 p-4 rounded-xl">
          <div className="text-lg font-semibold">
            <img src='https://framerusercontent.com/images/sh08yhQRcgeLTg8MSig179cTQ8.png' alt='sample'/>
          </div>
      ...
      <div className="flex justify-between items-center w-full max-w-screen-lg bg-gray-800 bg-opacity-50 p-4 rounded my-8">
        <img src="https://framerusercontent.com/images/7cluiGa2zIXh4KaBoIiX4Wd7g.png" alt='sample1'/>
      </div>

      <div>
        <p className='h-16'></p>
        <p className='h-16'></p>
      <p className="text-center font-inter  font-normal leading-7 mt-5 text-white text-xl mb-4 opacity-95">Trusted by fast-growing companies worldwide</p>
      </div>
      
      <div className="flex flex-wrap justify-center mb-16">
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img src="https://framerusercontent.com/images/b7Y3O7MuT7iGqIn9B8URsLPe9Zs.svg" alt="sample2" className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img src="https://framerusercontent.com/images/2FqRvjIsBIFF4zz0B5qX5zjd9ho.svg" alt="sample3" className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img src="https://framerusercontent.com/images/H0nYSP9UqjVanFxgROEITBt8c.svg" alt="sample4" className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img src="https://framerusercontent.com/images/ImBGm7FEySu7sDDQIAnnolcQq4.svg" alt="sample5" className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img src="https://framerusercontent.com/images/eboSRZ3S0bc7XvtDG9NJTZkNr8.svg" alt="sample6" className="w-full h-full object-cover rounded-lg"/>
  </div>
  <div className="w-1/2 md:w-1/4 lg:w-1/6 p-2">
    <img src="https://framerusercontent.com/images/hLfweuYR0swEKeJaGTFJTXcJz4M.svg" alt="sample7" className="w-full h-full object-cover rounded-lg"/>
  </div>
</div>



<div className="flex justify-between items-center w-full max-w-screen-lg bg-gray-800 bg-opacity-0 p-1 rounded mb-[25rem]">

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md-80">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 bg-opacity-5 ">
                 ...
                 <img src="https://cdn.create.vista.com/api/media/small/440249754/stock-video-turquoise-pencil-and-gear-icon-isolated-on-blue-background-creative-development-blogging-or-copywriting-concept?videoStaticPreview=true&token=" alt='sample10' />
                  </div>
                  <p className="mt-4 text-white text-center">Craft a winning solution that not only draws in more customers but also secures bigger projects.</p>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 bg-opacity-5">
                 ...
                 <img src="https://cdn.create.vista.com/api/media/small/440249754/stock-video-turquoise-pencil-and-gear-icon-isolated-on-blue-background-creative-development-blogging-or-copywriting-concept?videoStaticPreview=true&token=" alt='sample10' />
                  ...
                  <p className="mt-4 text-white text-center">Create a website that's lightning-fast, ultra-sleek, and mind-blowingly effective!</p>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 bg-opacity-5">
                 ...
                 <img src="https://cdn.create.vista.com/api/media/small/440249754/stock-video-turquoise-pencil-and-gear-icon-isolated-on-blue-background-creative-development-blogging-or-copywriting-concept?videoStaticPreview=true&token=" alt='sample10' />
                  ...
                  <p className="mt-4 text-white text-center">Make your site truly yours with effortless customization for your brand.</p>
                </div>
              </div>
    </div>
    ...
    <div className="framer-1bg2imx" data-framer-name="Wrap" name="Wrap" style={{ 
      ...
      <div className="absolute top-0 right-0 bottom-0 left-0 mt-12" data-framer-background-image-wrapper="true">
    <div className="flex justify-center items-center">
      <div className="flex flex-col items-center p-4 rounded">
        <div className="relative w-full h-full rounded">
          <img
            src="https://framerusercontent.com/images/OYx7j0kTuXKuhy21dIzv4Sejz0Q.svg" alt='sample11'
            className="w-full h-full rounded object-cover relative bottom-[8rem]"
          />
        </div>
      </div>
    </div>
    ...
    <div className="p-4 bg-gray-800 bg-opacity-0  rounded-md" data-framer-name="Title" name="Title">
        <div className="p-4  bg-gray-800 bg-opacity-0 rounded-md" data-framer-name="Wrap" name="Wrap mb-6">
              <div className="flex justify-center items-center bg-opacity-0">
                <h3 className="text-6xl font-normal text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/80 text-center">
                  Effortlessly customize
                </h3>
              </div>
              <div className="flex justify-center items-center">
                <h3 className="text-6xl font-normal text-transparent bg-clip-text bg-gradient-to-b from-purple-200 via-purple-300 to-purple-400 text-center">
          ...
          <div className="flex flex-col justify-start flex-shrink-0 mt-4">
            <p className="text-center text-base text-white">
              Customization is key to making any project 
            </p>
            <p className="text-center text-base text-white">
            successful since every project has its unique requirements and challenges.
            </p>
          </div>
      </div>
      </div>
        ...
        <div className="w-full md:w-1/2 flex-col items-center justify-center ">
          ...
          <div className='flex justify-left px-10'>
              <div className="w-full  px-4 py-12 pr-20">
                <h2 className="text-3xl  mb-4">Starting to develop</h2>
        ...
        <div className="w-full md:w-1/2 flex-col items-center justify-center">
          ...
          <div className='flex justify-left px-10 '>
              <div className="w-full  px-1 py-8 pr-20">
                <h2 className="text-3xl  mb-4">Extensions</h2>
    ...
    <div className='flex justify-between items-center w-full max-w-screen-lg bg-gray-800 bg-opacity-0 p-1 rounded px-12 '>
      <div className='flex justify-between mt-32 '>
          <div className="w-full text-5xl font-bold px-1  mb-4">
              <div>
    ...
    <div className='flex justify-between items-center w-full max-w-screen-lg bg-gray-800 bg-opacity-0 p-1 rounded px-10 mb-20'>
      
      <div className=' flex justify-between px-1  py-10'>
            <div className='border border-purple-700 rounded-lg '>
              <img src="https://framerusercontent.com/images/3uS8DUPZeyJ5GU35aRHJgFx594.png" alt='sample13'  />
            </div>
            <div className='border border-purple-700 rounded-lg  '>
              <img src="https://framerusercontent.com/images/XZv3jSCQ5RqwC9bnJNfup2aWB90.png" alt='sample14' />
            </div>
            <div className='border border-purple-700 rounded-lg '>
              <img src="https://framerusercontent.com/images/i92vyn1xS1aIVks1HCJduxyc1I.png" alt='sample15' />
            </div>
          </div>
      </div>
      ...
      <div className='flex justify-between items-center w-full max-w-screen-lg bg-opacity-0 p-1 rounded px-10 mt-20 '>
      <div className="flex-row justify-between items-center py-4 px-8  text-white opacity-60 mb-40">
      <div className=" ">
        <div className='  text-5xl mt-5 mb-5'>
          <h1 className='text-white  pl-3 mb-2'>Effortlessly customize</h1>
          <h1 className='text-purple-400 pl-3'>for your unique projects.</h1>
        </div> 
        <p className=" text-white pl-3">
          Customization is key to making any project successful since every project 
        </p>
        <p className=" text-white pl-3 ">
        has its unique requirements and challenges.
        </p>
      </div>



      <div className="flex flex-wrap justify-between items-center py-4 px-8 text-white mt-7">
          <div className="flex flex-row justify-between w-full mb-4">

            <div className="w-full lg:w-1/2 rounded-md shadow-md py-4 px-8 ">
              <h4 className='text-lg'>Dynamic Content Editor</h4>
            ...
            <div className="w-full lg:w-1/2 rounded-md shadow-md py-4 px-8 ">
              <h4 className='text-lg'>Adaptive Layouts</h4>
              <p className="text-white">
          ...
          <div className="flex flex-row justify-between w-full">
            <div className="w-full lg:w-1/2 rounded-md shadow-md py-4 px-8">
              <h4 className='text-lg'>Modular Components</h4>
              <p className="text-white">
            ...
            <div className="w-full lg:w-1/2 rounded-md shadow-md py-4 px-8  ">
              <h4 className='text-lg'>Smart Suggestions</h4>
              <p className="text-white">
...
<div className="bg-gray-900 text-white min-h-screen flex flex-col items-center">
  ...
  <div className="bg-gray-900 min-h-screen p-10 text-white flex justify-center items-center mb-80">
      <div className="max-w-screen-lg w-full ">
        <h1 className="text-5xl  mb-4">Check out the blogs we </h1>
        <h1 className="text-5xl text-purple-400 mb-14">have prepared for you</h1>
